 ...
 */
export const POLITICAL_GROUPS = {
  RN: { name: 'Rassemblement National', color: '#004B87' },
  LFI_NFP: { name: 'La France insoumise - Nouveau Front Populaire', color: '#CC2443' },
  SOC: { name: 'Socialistes et apparentés', color: '#FF8080' },
  ECO: { name: 'Écologiste et Social', color: '#00C000' },
  GDR: { name: 'Gauche Démocrate et Républicaine', color: '#DD0000' },
  EPR: { name: 'Ensemble pour la République', color: '#FFEB00' },
  DEM: { name: 'Les Démocrates', color: '#FF8C00' },
  HOR: { name: 'Horizons et apparentés', color: '#00BFFF' },
  DR: { name: 'Droite Républicaine', color: '#0066CC' },
  UDR: { name: 'Union des droites pour la République', color: '#003366' },
  NI: { name: 'Non inscrit', color: '#999999' },
  UNKNOWN: { name: 'Non spécifié', color: '#CCCCCC' },
} as const;
