...
import { ListMetaMedias, MetaMedia } from '../../models/meta-media';
      ...
      .subscribe((counts: any) => {
        ...
        if (this.installDate != null && this.installDate < a
          ...
          this.alertService.openExternalLink(
            'Soutenir ' + this.currentMetaMedia.title,
            'On dirait bien que vous appréciez ce contenu, souhaitez-vous soutenir les auteurs ? ',
            this.currentMetaMedia.donation
          );
